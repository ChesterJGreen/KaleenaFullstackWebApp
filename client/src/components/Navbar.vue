            ...
            <div class="col-2">
              <router-link class="navbar-brand d-flex" :to="{ name: 'Home' }">
                <div class="d-flex flex-column align-items-center ps-5">
                  <img src="src\assets\img\1-Homepage Logo Transparent.png" class="rounded-pill" height="175" alt="">
                </div>
              </router-link>
            </div>
                      ...
                      <div class="col-1">
                        <li>
                          <router-link :to="{ name: 'Contact' }" class="router btn text-dark selectable text-uppercase mx-2">
                            <img src="src\assets\img\1-Homepage Sweet Bites Newsletter Button.png" width="250">
                          </router-link>
                        </li>
                      </div>
                    </div>
